...
public class Boss_custom_manager : MonoBehaviour
{
    [SerializeField]
    [Tooltip("弾の発射場所")]
    ...
    private float weaponCount = 0.0f;
    private int weaponStopCount = 0;
    private float LastResortCount = 0.0f;
    ...
    void Update()
    {
        ...
        if (CPData.BOSS_start)
        {
            ...
            LastResortCount += Time.deltaTime;
            //メインカスタム
            //if (CPData.CustomNo1)
            //{
